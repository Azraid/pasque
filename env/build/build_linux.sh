...
go build  -race --o $GOPATH/bin/pasque/linux/juliusersrv $GOPATH/src/github.com/Azraid/pasque/services/julivonoblitz/juliusersrv/main.go $GOPATH/src/github.com/Azraid/pasque/services/julivonoblitz/juliusersrv/grid.go  $GOPATH/src/github.com/Azraid/pasque/services/julivonoblitz/juliusersrv/txn.go
