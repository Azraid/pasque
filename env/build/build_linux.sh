...
go build -o $GOPATH/bin/pasque/linux/hellosrv $GOPATH/src/pasque/server/hellosrv/main.go
go build -o $GOPATH/bin/pasque/linux/hellocli $GOPATH/src/pasque/server/hellocli/main.go
