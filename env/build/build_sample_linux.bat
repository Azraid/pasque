...
go build -o %gopath%\bin\pasque\linux\svcgate %gopath%\src\pasque\bus\svcgate\main.go %gopath%\src\pasque\bus\svcgate\gate.go
go build -o %gopath%\bin\pasque\linux\apigate %gopath%\src\pasque\bus\apigate\main.go %gopath%\src\pasque\bus\apigate\gate.go
