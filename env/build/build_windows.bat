...
go build -o %gopath%\bin\pasque\windows\apigate.exe %gopath%\src\pasque\server\apigate\main.go %gopath%\src\pasque\server\gamegate\gate.go
go build -o %gopath%\bin\pasque\windows\hellosrv.exe %gopath%\src\pasque\server\hellosrv\main.go 
go build -o %gopath%\bin\pasque\windows\hellocli.exe %gopath%\src\pasque\server\hellocli\main.go
